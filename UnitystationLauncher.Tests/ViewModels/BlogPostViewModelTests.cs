...
public static class BlogPostViewModelTests
{
    ...
    {
        BlogPostViewModel blogPostViewModel = new(string.Empty, string.Empty, null, postImage);
    ...
    public static void BlogPostViewModel_ShouldHandleCommaSeperatedValues()
    {
        ...
        BlogPostViewModel blogPostViewModel = new(string.Empty, string.Empty, null, test);
    ...
    {
        BlogPostViewModel blogPostViewModel = new(string.Empty, string.Empty, null, "imageLinkGoesHere");
    ...
    {
        BlogPostViewModel blogPostViewModel = new("titleGoesHere", string.Empty, null, string.Empty);
    ...
    {
        BlogPostViewModel blogPostViewModel = new(string.Empty, "linkGoesHere", null, string.Empty);
    ...
    {
        BlogPostViewModel blogPostViewModel = new(string.Empty, String.Empty, DateOnly.Parse("2023-05-16"), string.Empty);

        blogPostViewModel.PostDate.Should().Be("2023-05-16");
